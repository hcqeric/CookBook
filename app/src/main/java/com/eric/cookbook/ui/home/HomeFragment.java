...
//        rv_total_menu.addOnScrollListener(new RecyclerView.OnScrollListener() {
//            @Override
//            public void onScrollStateChanged(RecyclerView recyclerView, int menuState) {
//                super.onScrollStateChanged(recyclerView, menuState);
//                LayoutManager layoutManager = recyclerView.getLayoutManager();
//                int lastVisibleItemPosition = ((LinearLayoutManager) layoutManager)
//                        .findLastVisibleItemPosition();
//                int visibleItemCount = layoutManager.getChildCount();
//                int totalItemCount = layoutManager.getItemCount();
//                Log.e("if is TRUE", (menuTotalListAdapter.getItemCount() < 60) + "");
//                Log.e("if is TRUE", (visibleItemCount > 0) + "");
//                Log.e("if is TRUE", (lastVisibleItemPosition >= totalItemCount - 1) + "");
//                Log.e("if is TRUE", "lastVisibleItemPosition = " + lastVisibleItemPosition + "");
//                Log.e("if is TRUE", "totalItemCount = " + totalItemCount + "");
//
//                if ( menuTotalListAdapter.getItemCount() < 60 && visibleItemCount > 0 && menuState == RecyclerView.SCROLL_STATE_IDLE
//                        && lastVisibleItemPosition >= totalItemCount - 1) {
//                    Log.d("TAG+++++++++++", "MORE ----------------");
//                    homePresenter.loadMoreMenu();
//                    menuTotalListAdapter.showFooter();
//                    menuTotalListAdapter.notifyItemInserted(menuTotalListAdapter.getItemCount());
//                    rv_total_menu.scrollToPosition(menuTotalListAdapter.getItemCount() - 1);
//                }
//            }
//        });
//        rv_total_menu.setAdapter(menuTotalListAdapter);
    }
...
//        menuTotalListAdapter.hideFooter();
//        menuTotalListAdapter.notifyItemRemoved(menuTotalListAdapter.getItemCount());
//        if (dataBeans == null || dataBeans.size() == 0) {
////            mIsAllLoaded = true;
////            Snackbar.make(mNewsRv, getString(R.string.no_more), Snackbar.LENGTH_SHORT).show();
//        } else {
//            Log.d("TAGS-------------",  dataBeans + "");
//            menuTotalListAdapter.addMore(dataBeans);
//            menuTotalListAdapter.notifyDataSetChanged();
//        }
    }
